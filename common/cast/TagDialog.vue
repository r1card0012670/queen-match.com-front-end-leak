            ...
            <v-card :class="[`d-class-cast`, 'd-border-radius-top-15']" :id="`dialog-class-cast`">
                <v-card-title :id="'d-card-title-class-cast'"
                    ...
                    <div class="d-flex align-items-center justify-content-between d-custom-header p-2 d-width-100">
                        ...
                        <v-btn class="info-bar d-act-title-class-cast pr-0 button-choice" color="green darken-1" text @click="clickCallbackEventData">
                            設定
                        </v-btn>
                    </div>
                </v-card-title>
                ...
                <v-card-text :id="'d-card-text-feed-detail'">
                    <v-checkbox v-model="vModelData" label="スタンダード" value="スタンダード" :class="`form-check`"></v-checkbox>
                    <v-checkbox v-model="vModelData" label="VIP" value="VIP" :class="`form-check`"></v-checkbox>
                    <v-checkbox v-model="vModelData" label="ロイヤルVIP" value="ロイヤルVIP" :class="`form-check`"></v-checkbox>
                </v-card-text>
            </v-card>
        </v-bottom-sheet>
    </div>
